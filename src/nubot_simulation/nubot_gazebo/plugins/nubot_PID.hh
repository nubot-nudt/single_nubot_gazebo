...
namespace nubot
{
    ...
    class PID
    {
      ...
      /// \param[_in] _error  Error since last call (p_target - p_state).
      ...
      public: double Update(double _error, double dt);
      ...
      /// \brief Return PID terms for the controller.
      /// \param[in] _pt  The proportional error term.
      /// \param[in] _it  The integral error term.
      /// \param[in] _dt  The derivative error term.
      public: void GetTerms(double &_pt, double &_it, double &_dt);
