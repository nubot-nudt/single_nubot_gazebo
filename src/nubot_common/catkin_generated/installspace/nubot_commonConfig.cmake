...
if("FALSE" STREQUAL "TRUE")
  set(nubot_common_SOURCE_PREFIX /home/winston/workspace/nubot_ws/src/nubot/nubot_common)
  set(nubot_common_DEVEL_PREFIX /home/winston/workspace/nubot_ws/src/devel)
  ...
  set(nubot_common_INSTALL_PREFIX /usr/local)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'nubot_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'nubot <nubot.nudt@gmail.com>, nubot <nubot.nudt@outlook.com>' to fix it.")
    endif()
...
set(nubot_common_EXPORTED_TARGETS "nubot_common_generate_messages_cpp;nubot_common_generate_messages_lisp;nubot_common_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${nubot_common_dep}_FOUND)
      find_package(${nubot_common_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${nubot_common_dep} REQUIRED ${depend_list})
  endif()
